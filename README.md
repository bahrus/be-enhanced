...
| be-persistent       | [Two-way-bind](https://github.com/bahrus/be-persistent) from a property to a local store               | [code](https://github.com/bahrus/be-persistent/blob/baseline/be-persistent.js)
